            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover table-bordered align-middle mb-0">
                        ...
                        @empty
                            <tr>
                                <td colspan="{{ 8 + ($jumlahShiftSetting >= 2 ? 1 : 0) + ($jumlahShiftSetting == 3 ? 1 : 0) }}" class="text-center py-4 text-muted">
