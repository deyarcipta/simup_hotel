                                ...
                                @forelse($transaksi as $trx)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('admin.transaksi.update-status', $trx->id) }}" method="POST" class="d-flex align-items-center gap-1 mt-1">
                                                @csrf @method('PUT')
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('admin.transaksi.update-status', $trx->id) }}" method="POST">
                                                @csrf @method('PUT')
                                        ...
                                        <td>
                                            <div class="d-flex gap-1">
                                                <a href="{{ route('admin.transaksi.print', $trx->id) }}" target="_blank" class="btn btn-icon btn-outline-primary btn-sm" title="Cetak Nota"><i class="bx bx-printer"></i></a>
                                                @if($trx->nomor_wa)
            ...
            if (data.success) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        const printUrl = `{{ url('admin/transaksi') }}/${data.transaksi_id}/print`;
                    ...
                    cart = [];
                    renderCart();
                    window.location.href = "{{ route('transaksi.index') }}?tab=riwayat";
                });
            } else {
