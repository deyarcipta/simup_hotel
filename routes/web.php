...
Route::middleware(['auth', 'role:admin'])
    ...
    ->group(function () {
        ...
        Route::put('transaksi/{id}/status', [AdminTransaksiController::class, 'updateStatus'])->name('admin.transaksi.update-status');
        Route::delete('transaksi/{id}', [AdminTransaksiController::class, 'destroy'])->name('transaksi.destroy');
        Route::get('transaksi/{id}/print', [AdminTransaksiController::class, 'printNota'])->name('admin.transaksi.print');
        ...
        // Pengeluaran Lain (Tanpa Gaji Karyawan)
...
Route::middleware(['auth', 'role:operator'])
    ...
    ->group(function () {
        ...
        Route::put('transaksi/{id}/status', [TransaksiController::class, 'updateStatus'])->name('operator.transaksi.update-status');
        Route::delete('transaksi/{id}', [TransaksiController::class, 'destroy'])->name('operator.transaksi.destroy');
        Route::get('transaksi/{id}/print', [TransaksiController::class, 'printNota'])->name('operator.transaksi.print');
