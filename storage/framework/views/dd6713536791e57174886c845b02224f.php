...
<?php if(session('wa_selesai_url')): ?>
<script>
    Swal.fire({
        icon: 'success',
        title: 'Laundry Selesai',
        text: 'Status laundry berhasil diperbarui menjadi selesai. Kirim notifikasi ke WhatsApp pelanggan?',
        ...
        if (result.isConfirmed) {
            window.open('<?php echo session('wa_selesai_url'); ?>', '_blank');
        }
    });
</script>
...
<?php /**PATH C:\laragon\www\simup_hotel\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>