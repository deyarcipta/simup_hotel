                                ...
                                <div class="row row-cols-2 row-cols-sm-2 row-cols-md-3 g-2 g-sm-3 etalase-grid" style="max-height: 580px; overflow-y: auto; padding: 5px;">
                                    <?php $__currentLoopData = $produkJasa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col etalase-item" 
                                             ...
                                             <div class="card h-100 border rounded-3 p-2 p-sm-3 text-center position-relative etalase-card shadow-sm cursor-pointer <?php echo e($isOutOfStock ? 'opacity-50 bg-light' : ''); ?>" 
                                                 style="transition: all 0.2s;"
                                                 onclick="<?php echo e(!$isOutOfStock ? 'addToCart('.$item->id.')' : ''); ?>">
                                                
                                                
                                                <span class="badge position-absolute top-0 start-50 translate-middle-y <?php echo e($item->jenis === 'jasa' ? 'bg-info' : 'bg-success'); ?>" style="font-size: 0.65rem;">
                                                    <?php echo e($item->jenis === 'jasa' ? 'Layanan Jasa' : 'Produk'); ?>

                                                </span>
                                                
                                                <div class="mt-3 mb-1 fw-bold text-dark" title="<?php echo e($item->nama); ?>" style="font-size: 0.85rem; line-height: 1.2; min-height: 2.4em; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
            ...
            <div class="tab-pane fade" id="pills-riwayat" role="tabpanel" aria-labelledby="pills-riwayat-tab">
                <div class="card shadow-sm border-0">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Daftar Transaksi & Pelacakan Cucian (Admin)</h5>
                        <div class="d-flex gap-2">
                            <a href="<?php echo e(route('transaksi.download')); ?>" class="btn btn-success btn-sm">
                                <i class="bx bx-download"></i> Laporan PDF Transaksi
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                             <form method="GET" action="<?php echo e(route('transaksi.index')); ?>" class="d-flex gap-2">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $transaksi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="fw-bold text-dark">
                                            <?php echo e($trx->kode_transaksi); ?>

                                            <div class="text-muted mt-1" style="font-size: 0.75rem; font-weight: normal;">
                                                <i class="bx bx-user text-primary" style="font-size: 0.85rem;"></i> Kasir: <strong><?php echo e($trx->user->name ?? 'System'); ?></strong>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <form action="<?php echo e(route('admin.transaksi.update-status', $trx->id)); ?>" method="POST" class="d-flex align-items-center gap-1 mt-1">
                                        ...
                                        <td>
                                            ...
                                            <form action="<?php echo e(route('admin.transaksi.update-status', $trx->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                        ...
                                        <td>
                                            <div class="d-flex gap-1">
                                                <a href="<?php echo e(route('admin.transaksi.print', $trx->id)); ?>" target="_blank" class="btn btn-icon btn-outline-primary btn-sm" title="Cetak Nota"><i class="bx bx-printer"></i></a>
                                                <?php if($trx->nomor_wa): ?>
                                                ...
                                                <?php endif; ?>
                                                <form action="<?php echo e(route('transaksi.destroy', $trx->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus transaksi ini? Kuantitas stok barang akan dikembalikan.')">
...
<script>
    ...
    function toggleRoomInput() {
        ...
        if (jenisPelanggan === 'tamu') {
            ...
            paymentSelect.value = 'belum_lunas'; // Tamu hotel biasanya charge ke kamar
    ...
    function submitCheckout() {
        ...
        fetch('<?php echo e(route("transaksi.store")); ?>', {
            method: 'POST',
            headers: {
            ...
            if (data.success) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        const printUrl = `<?php echo e(url('admin/transaksi')); ?>/${data.transaksi_id}/print`;
                    ...
                    cart = [];
                    renderCart();
                    window.location.href = "<?php echo e(route('transaksi.index')); ?>?tab=riwayat";
                });
            } else {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\simup_hotel\resources\views/admin/transaksi/index.blade.php ENDPATH**/ ?>