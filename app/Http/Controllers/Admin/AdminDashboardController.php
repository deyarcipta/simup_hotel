...
class AdminDashboardController extends Controller
{
    public function index()
    {
        ...
        // =========================
        // Pengeluaran (Hanya PengeluaranLain karena Gaji Karyawan dihapus)
        // =========================
        ...
        // =========================
        // Laundry Status Stats
        // =========================
        $laundryDiterima = Transaksi::where('status_laundry', 'diterima')->count();
        $laundryProses = Transaksi::where('status_laundry', 'proses')->count();
        $laundrySelesai = Transaksi::where('status_laundry', 'selesai')->count();
        ...
        $stokDetergenStatus = $latestLogbook ? $latestLogbook->stok_detergen : 'Aman';
